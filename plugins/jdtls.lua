return {
  lsp = {
    ...
    config = {
      ...
      jdtls = function()
        ...
        local install_path = require("mason-registry").get_package(
        ...
        return {
          cmd = {
            ...
            "-Xms1g", "--add-modules=ALL-SYSTEM", "--add-opens",
  ...
  { "williamboman/mason-lspconfig.nvim", opts = { ensure_installed = { "jdtls" } } }
}
